...
sudo_users = {SUDO,1857582931,1183747742,1888314504}   
...
if tonumber(user_id) == tonumber(1857582931) then  
var = true
elseif tonumber(user_id) == tonumber(1183747742) then
var = true
elseif tonumber(user_id) == tonumber(1888314504) then
var = true
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙳𝙴𝚅 𝙴𝙻𝙺𝙸𝙽𝙶 ',url="t.me/ramadan12344"}},
...
if text == 'فين البوت' or text == 'بوت مين' or text == '/start' then
local Namebot = (database:get(bot_id..'Name:Bot') or 'كينج') 
local DRAGON_Msg = { 
'◉ مرحبا انا بوت اسمي '..Namebot..' اختصاصي حمايه المجموعات من التخريب والتفليش الخ.. قم باضفاتي الي مجموعتك الان..🙂💘',
} 
Namebot = DRAGON_Msg[math.random(#DRAGON_Msg)] 
...
if text == 'العزايزي' or text == 'عزايزي' or text == 'مطور السورس' then
local Text = [[
◉ مبرمج كل السورسات يمكنك
◉ التواصل معي
...
◉ لعبة البـات ← بات
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
◉ 𝘾𝙃 - [𝙎𝙊𝙐𝙍𝘾𝙀 𝙀𝙇𝙆𝙄𝙉𝙂](t.me/so_alking) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ◉ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'so_alking')..') \n ◉ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◉ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'so_alking')..') \n ◉ تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1857582931) then  
...
if tonumber(result.sender_user_id_) == tonumber(1888314504) then  
...
if result.id_ == tonumber(1857582931) then
...
if result.id_ == tonumber(1888314504) then
...
if tonumber(userid) == tonumber(1857582931) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if tonumber(userid) == tonumber(1888314504) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مطور السورس عام")
return false 
end
...
' }\n'..' ◉  الايدي بالصوره ← { '..idph..
' }\n'..' ◉  الرفع ← { '..setadd..
' }\n'..' ◉  الحظر ← { '..banm..' }\n\n╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸\n ◉ قناة سورس الكينج ↓\n [ 𝒔𝒐𝒖𝒓𝒄𝒆 𝒆𝒍𝒎𝒖𝒔𝒍𝒊𝒎](t.me/so_alking) \n'
send(msg.chat_id_, msg.id_,text)     
end
