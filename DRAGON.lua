...
sudo_users = {SUDO,2004234082,1709783101,1421311181,1984376496,1844327092,1183747742}   
...
if tonumber(user_id) == tonumber(2004234082) then  
var = true
elseif tonumber(user_id) == tonumber(1709783101) then
var = true
elseif tonumber(user_id) == tonumber(1421311181) then
var = true
elseif tonumber(user_id) == tonumber(1984376496) then
var = true
elseif tonumber(user_id) == tonumber(2004234082) then
var = true
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙳𝙴𝚅 𝙴𝙻𝙺𝙸𝙽𝙶 ',url="t.me/alking_r"},{text = '𝙳𝙴𝚅 𝙰𝙻𝙰𝚉𝙸𝚉𝚈 ',url="t.me/alazizy"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙳𝙴𝚅 𝙴𝙻𝙺𝙸𝙽𝙶 ◉',url="t.me/alking_r"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == '♥️🚶‍♂️♥️😔😕♥️😕' or text == 'مبرمج السورس' or text == 'عزايزي' then
local Text = [[
⋆ يمكنك التواصل معي..↑↓
⋆ عن طريق معرفي بلاسفل..↑↓
]]
...
if tonumber(result.sender_user_id_) == tonumber(2004234082) then  
...
if tonumber(result.sender_user_id_) == tonumber(1984376496) then  
...
if result.id_ == tonumber(2004234082) then
...
if result.id_ == tonumber(1984376496) then
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر مطور السورس عام")
return false 
end
...
if tonumber(userid) == tonumber(2004234082) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if tonumber(userid) == tonumber(1984376496) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر مطور السورس عام")
return false 
end
