...
sudo_users = {SUDO,1922687101,1709783101,1421311181,1733808997,1844327092,1183747742}   
...
if tonumber(user_id) == tonumber(1922687101) then  
var = true
...
var = true
elseif tonumber(user_id) == tonumber(1922687101) then
var = true
...
if tonumber(result.sender_user_id_) == tonumber(1922687101) then  
...
if result.id_ == tonumber(1922687101) then
...
if tonumber(userid) == tonumber(1922687101) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر مبرمج السورس عام")
return false 
end
