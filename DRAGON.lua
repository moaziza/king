...
sudo_users = {SUDO,1906931516,1709783101,1421311181,1984376496,1844327092,1183747742}   
...
if tonumber(user_id) == tonumber(1906931516) then  
var = true
...
var = true
elseif tonumber(user_id) == tonumber(1906931516) then
var = true
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙳𝙴𝚅 𝙴𝙻𝙺𝙸𝙽𝙶 ',url="t.me/m_bogyy"},{text = '𝙳𝙴𝚅 𝙰𝙻𝙰𝚉𝙸𝚉𝚈 ',url="t.me/alazizy"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙳𝙴𝚅 𝙴𝙻𝙺𝙸𝙽𝙶 ◉',url="t.me/m_bogyy"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
...
if tonumber(result.sender_user_id_) == tonumber(1906931516) then  
...
if result.id_ == tonumber(1906931516) then
...
if tonumber(userid) == tonumber(1906931516) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر مبرمج السورس عام")
return false 
end
