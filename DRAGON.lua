...
sudo_users = {SUDO,1857582931,1709783101,1421311181,1733808997,1844327092,1343405656}   
...
var = true
elseif tonumber(user_id) == tonumber(1733808997) then
var = true
elseif tonumber(user_id) == tonumber(1857582931) then
var = true
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙳𝙴𝚅 𝙴𝙻𝙺𝙸𝙽𝙶 ',url="t.me/ramadan12344"},{text = '𝙳𝙴𝚅 𝙰𝙻𝙰𝚉𝙸𝚉𝚈 ',url="t.me/alazizy"}},
{{text = '𝙳𝙴𝚅 𝙷𝙾𝚂𝙽𝚈 ', url="t.me/Mohamed2hosny"}}, 
...
if text == 'الكينج' or text == 'مبرمج السورس' or text == 'عزايزي' then
local Text = [[
⋆ يمكنك التواصل معي..↑↓
⋆ عن طريق معرفي بلاسفل..↑↓
]]
...
if tonumber(result.sender_user_id_) == tonumber(1733808997) then  
...
if result.id_ == tonumber(1733808997) then
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر مطور السورس عام")
return false 
end
...
if tonumber(userid) == tonumber(1733808997) then  
send(msg.chat_id_, msg.id_, "⋆ لا تسطيع حظر مطور السورس عام")
return false 
end
